...
namespace Assets.Extensions.RaymapExportOld.Assets.Scripts.AnimatedModelExport.R3PCFull.Model
{
    public class RaymapAnimatedPersoDescriptionR3
    {
        public string name;
        public ExportObjectsLibraryModel exportObjectsLibrary;
