...
{
    public class BoneChannelMappingHelper
    {
        public static string GetCorrespondingChannelNameForActualBoneAssociation(UnityBoneTransformModel unityBoneTransformModel)
        {
