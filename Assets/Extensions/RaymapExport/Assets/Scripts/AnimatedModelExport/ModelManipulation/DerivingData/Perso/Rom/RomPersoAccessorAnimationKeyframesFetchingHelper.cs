...
{
    public class RomPersoAccessorAnimationKeyframesFetchingHelper : RomPersoAccessorAnimationDataFetchingHelper
    {
        public RomPersoAccessorAnimationKeyframesFetchingHelper(RomPersoAccessor romPersoAccessor) : base(romPersoAccessor)
        {
        }
