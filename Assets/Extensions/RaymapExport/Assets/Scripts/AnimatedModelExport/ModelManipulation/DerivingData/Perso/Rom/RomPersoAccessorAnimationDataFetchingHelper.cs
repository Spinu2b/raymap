...
{
    public abstract class RomPersoAccessorAnimationDataFetchingHelper
    {
        protected RomPersoAccessor romPersoAccessor;

        public RomPersoAccessorAnimationDataFetchingHelper(RomPersoAccessor romPersoAccessor)
        {
