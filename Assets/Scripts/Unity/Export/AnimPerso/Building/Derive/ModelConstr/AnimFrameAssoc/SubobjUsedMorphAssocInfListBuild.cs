...
namespace Assets.Scripts.Unity.Export.AnimPerso.Building.Derive.ModelConstr.AnimFrameAssoc
{
    ...
    public class SubobjectUsedMorphAssociationInfoListBuilder
    {
        ...
        private IEnumerable<SubobjectUsedMorphAssociationInfo> GetMorphFinalDataFor(int physicalObjectNumberFrom, int physicalObjectNumberTo)
        {
            ...
            foreach (var morphFrameNumber in
                objectFromObjectToFrameNumberMorphProgressAssociationsBuildingBlocks[physicalObjectNumberFrom][physicalObjectNumberTo].Keys.OrderBy(x => x))
            {
                float morphProgress = objectFromObjectToFrameNumberMorphProgressAssociationsBuildingBlocks[physicalObjectNumberFrom][physicalObjectNumberTo][morphFrameNumber];
